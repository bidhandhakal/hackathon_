...
const nepaliCities = ['Kathmandu', 'Lalitpur', 'Bhaktapur', 'Pokhara', 'Chitwan', 'Biratnagar']
const allServices = [
  'Electricians', 'Plumbers', 'Carpenters', 'House painters', 'Appliance repair technicians',
  'Cleaning helpers', 'Household helpers', 'Babysitters', 'Delivery helpers', 'Errand helpers',
  'Home tutors', 'Language tutors', 'Photographers', 'Videographers', 'Garden workers',
]
...
export default function Hero() {
  ...
  const filteredServices = searchQuery ? allServices.filter(s => s.toLowerCase().includes(searchQuery.toLowerCase())) : []
  const filteredCities = locationQuery ? nepaliCities.filter(c => c.toLowerCase().includes(locationQuery.toLowerCase())) : []
